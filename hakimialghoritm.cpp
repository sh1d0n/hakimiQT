#include "hakimialghoritm.h"
#include "graphwidget.h"
#include "edge.h"

hakimiAlghoritm::hakimiAlghoritm()
{
   hakimiAlghoritm* hakimi;
}

void hakimiAlghoritm::deikstra(std::vector<std::vector<int>> matrix, std::vector<std::vector<int>>& matrixD)
{
...
void hakimiAlghoritm::deikstra(std::vector<std::vector<int>> matrix, int matrixSize, std::pair<int,int>& topWithMax)
{
...
int hakimiAlghoritm::findMaxMin(std::vector<std::vector<int>> matrixD, int& index)
{
...
void hakimiAlghoritm::findExistingRibs(std::vector<std::vector<int>> matrix, std::vector<ribs>& availableRibs, std::vector<std::vector<int>> matrixD)
{
...
void hakimiAlghoritm::findAvailableRibs(std::vector<ribs>& ribs, int upperBound)
{
...
void hakimiAlghoritm::fillNewMatrix(std::vector<std::vector<int>> matrix, std::vector<std::vector<int>>& newMatrix, ribs activeRib)
{
...
void main()
{
    ...
    else
    {
        ...
        result = "Place on(" + QString::number(nRibs[needTop].firstTop + 1) + "," + QString::number(nRibs[needTop].secondTop  + 1) + ")";
